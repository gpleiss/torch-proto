...
local M = {}
local BirdsDataset = torch.class('resnet.BirdsDataset', M)

function BirdsDataset:__init(imageInfo, opt, split)
...
function BirdsDataset:_loadImage(path)
...
function BirdsDataset:preprocess()
